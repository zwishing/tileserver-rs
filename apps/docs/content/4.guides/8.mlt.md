...
## MLT support capabilities

tileserver-rs implements MLT support in three phases:

### Direct MLT passthrough (always enabled)
...
### MVT-to-MLT transcoding (enabled by default)
...
### MLT-to-MVT transcoding (enabled by default)
...
| From        | To          | Status                          |
| ----------- | ----------- | ------------------------------- |
| MLT         | MVT/PBF     | ✅ Supported (MLT-to-MVT transcoding)          |
| MVT/PBF     | MLT         | ✅ Supported (MVT-to-MLT transcoding)          |
