...
Try a smaller model. Qwen3 0.6B requires only ~1.4 GB of VRAM. Close other GPU-intensive tabs or applications. On systems with shared GPU memory (integrated graphics), ensure enough system RAM is available.
