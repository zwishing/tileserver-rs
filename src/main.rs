...
fn api_router(state: SharedState) -> Router {
    Router::new()
        ...
        .route("/api/spatial/query", post(post_spatial_query))
        .with_state(state)
}
